...
insert into porcentaje values(1,4,'2023-05-11',Null, 'ACTIVO');
...
fecha DATE NOT NULL,
UNIQUE(id),
PRIMARY KEY (id_medico,horario_inicial,horario_final,fecha),
FOREIGN KEY (id_medico) REFERENCES USUARIO(id) ON UPDATE CASCADE
);
...
id_medico INT NOT  NULL,
id_especialidad INT NOT NULL,
porcentaje DECIMAL(9,9) NOT NULL,
...
id_paciente INT NOT NULL,
id_lab INT NOT NULL,
porcentaje DECIMAL(9,5) NOT NULL,	
...
CREATE TABLE RESULTADOS_SOLICITUDES_EXAMENES(
